...
<body class="flex flex-col min-h-screen bg-custom-light-gray">
    ...
    <h1 class="text-3xl font-bold text-custom-blue text-center mb-4 mt-8">Incidencias por Prioridad</h1>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
            <div class="bg-red-500 text-white rounded-lg shadow-md p-6 text-center transition-transform transform hover:scale-105">
                <h3 class="text-xl font-semibold">Prioridad Alta</h3>
                <p class="text-3xl font-bold">10</p>
            </div>
            <div class="bg-yellow-500 text-white rounded-lg shadow-md p-6 text-center transition-transform transform hover:scale-105">
                <h3 class="text-xl font-semibold">Prioridad Media</h3>
                <p class="text-3xl font-bold">15</p>
            </div>
            <div class="bg-green-500 text-white rounded-lg shadow-md p-6 text-center transition-transform transform hover:scale-105">
                <h3 class="text-xl font-semibold">Prioridad Baja</h3>
                <p class="text-3xl font-bold">5</p>
            </div>
        </div>
        
        <h1 class="text-3xl font-bold text-custom-blue text-center mb-4 mt-8">Estadísticas de Uso</h1>
