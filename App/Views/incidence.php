                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex space-x-3">
                                                <button class="text-blue-600 hover:text-blue-800" aria-label="Editar usuario #USR-001">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                    </svg>
                                                </button>
                                                <a href="/adminusuarios/eliminar/001" aria-label="Eliminar usuario #USR-001">
                                                    <button class="text-red-600 hover:text-red-800" aria-label="Eliminar usuario #USR-001">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
