...
<a href="/paneladministrador" class="nav-button-custom w-1/4 focus:outline-none">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18V3H3zm4 10h2v4H7v-4zm4-6h2v10h-2V7zm4 2h2v8h-2V9z" />
            </svg>
            <span>Estadísticas</span>
        </a>
        <a href="/adminincidencias" class="nav-button-custom w-1/4 focus:outline-none">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span>Incidencias</span>
        </a>
        <a href="/adminmaquinas" class="nav-button-custom w-1/4 focus:outline-none">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/adminmantenimiento" class="nav-button-custom w-1/4 focus:outline-none">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2v20m10-10H2" />
            </svg>
            <span>Mantenimiento</span>
        </a>
        <a href="/adminusuarios" class="nav-button-custom w-1/4 focus:outline-none">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
