                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex space-x-3">
                                    <button class="text-gray-600 hover:text-gray-800" onclick="window.location='/maquina/2'" aria-label="Ver detalles de máquina #MAQ-2">
                                    ...
                                    <a href="/incidencia/eliminar/<?= $incidence["id"] ?>" class="cursor-pointer text-red-600 hover:text-red-800" aria-label="Editar máquina #MAQ-<?= $incidence["id"] ?>">
